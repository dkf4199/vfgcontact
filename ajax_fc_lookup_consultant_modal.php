...
session_start();
	...
	$fname = $_GET['c_first'];			//contacts firstname
	$lname = $_GET['c_last'];			//contacts lastname
	...
	$displayform .= '</select>&nbsp;&nbsp;&nbsp;
			...
			<div id="set_consultant_timezone" style="text-align:center;"></div>
			</p>
				...
				<ul>
					...
					<li>
						...
						<input name="repadd_event_shortdesc" id="repadd_event_shortdesc" type="text" size="50" maxlength="100" 
							value="Appt for '.$fname.' '.$lname.'.  Set by '.$_SESSION['rep_firstname'].' '.$_SESSION['rep_lastname'].'" />
					</li>
					<li>

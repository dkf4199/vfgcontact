...
session_start();
	...
	$displayform = '<div style="display:none">
		...
		<h1 class="contact-title">3x3 Email Note for '.$fname.' '.$lname.' at '.$toemail.'.</h1>
		<div class="contact-loading" style="display:none"></div>
		<div class="contact-message" style="display:none"></div>
		<br />
		<ul>
			<li>
				<label for="mail_note">Email Note:</label>
				<input type="text" name="mail_note" id="mail_note" class="input250" maxlength="30" value="" />
			</li>
			<li>
				<label>&nbsp;</label>
				<a href="'.$currcid.'" class="matrixmaillink">Save 3x3 Email Note</a>&nbsp;&nbsp;

<?php
	...
	/*$q = "SELECT a.firstname, a.lastname, a.email, a.phone, a.assigned_consultant, a.next_action_date,
				 b.lastname as conlast, b.firstname as confirst, b.purchased_policy
		  FROM contacts a INNER JOIN reps b ON a.assigned_consultant = b.vfgrepid
		  WHERE a.tier_status = '3B'
		  ORDER BY a.next_action_date DESC";
	*/
	$q = "SELECT a.rep_id, a.firstname, a.lastname, a.email, a.phone, a.assigned_consultant, a.next_action_date,
				 b.lastname as conlast, b.firstname as confirst, b.purchased_policy,
	...
	if ($r) {
		...
		echo '<table id="reports_table">
						<tr>
							<th colspan=6>Tier 4 - Calls Made</th>
						</tr>
						<tr>

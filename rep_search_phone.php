...
$_SESSION['from_page'] = 'rep_search_phone.php';
$_SESSION['back_btn_text'] = 'Back To Search by Phone';
?>
<!DOCTYPE html>
<html>
<head>
...
<title>VFG Contact - First Name Search</title>
<!-- CSS -->
...
<div id="wrapper">
	...
	<div class="maincontent">
		...
		<div style="text-align:center;">
			<form method="get" action="rep_search_phone.php">
				<label>Search by Phone:</label>
				<input type="text" name="srch" id="srch" class="input125" value="<?php if (isset($_GET['srch'])) echo $_GET['srch']; ?>" />
		...
		<?php
			...
			//Link back fields for edit screen
			$_SESSION['from_page'] = 'rep_search_phone.php';
			$_SESSION['back_btn_text'] = 'Back To Phone Search';
			...
			if ($searchstr != ''){
				...
				if ($r) { // If it ran OK, display the records.
					...
					echo '<table id="csstable">
						<tr>
							<th colspan=7>SEARCH RESULTS - First Name</th>
						</tr>
						<tr>

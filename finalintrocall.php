...
session_start();
	...
	$scriptstr = '<p>
		...
		Hello '.$fname.'. This is '.$repfirst.' '.$replast.' with the Virtual Financial Group calling back for a 3rd and final time.  You had requested information from me on my 
		website regarding our incredible virtual financial services business opportunity you can do from home.  If you are interested you will need to call me now at '.$repphone.' so that we can discuss the videos.<br />
		I hope you don\'t miss this opportunity of a lifetime. My website is '.$h_link.'<br />
		Have a great day.<br /><br />
		<a href="#" class="savevm" onClick="javascript: return saveScriptToHistory(\''.$cid.'\',\'finalcall\',\'vm\');">Save Voicemail - Send Email/Text</a>&nbsp;
		<input type="checkbox" name="ic3_vm_trifecta_email" id="ic3_vm_trifecta_email" value="Y" >Send Email&nbsp;
		<input type="checkbox" name="ic3_vm_trifecta_text" id="ic3_vm_trifecta_text" value="Y" >Send Text<br /><br />
		</p>

		<p>
		<b>Conversation</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<a href="#" class="saveconvo" 
			onClick="javascript: return saveScriptToHistory(\''.$cid.'\',\'finalcall\',\'cv\');">Save Conversation to History.</a>&nbsp;&nbsp;&nbsp;
		<a href="#" class="saveconvo" 

...
session_start();
	...
	if ($r) { // If it ran OK, display the record.
		...
		while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
			...
			echo '<p align="center">
					<span class="editheader">Flush Contact: '.$row['firstname'].' '.$row['lastname'].'</span></p>';
			
			$displayform = 
					'<div class="dumpdiv">
						
						<form name="flushdumpcontact_form" id="flushdumpcontact_form" onSubmit="return flushContact()" >
							<div id="timedivwrap">
							...
							<p align="center"><font color="red">WARNING:</font>  Flushing this contact will PERMANENTLY remove contact from the system!
							</p>
						</form>
					</div>';
			echo $displayform;

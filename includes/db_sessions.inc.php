...
function open_session() {
	...
	//local
    $sdbc = mysqli_connect ('localhost', 'sessions', 'sessions^99', 'vfgcontact');
    //production
	//$sdbc = mysqli_connect ('localhost', 'spiritdr_sessionwebuserW', 'sessionwebUser^99', 'sessions');

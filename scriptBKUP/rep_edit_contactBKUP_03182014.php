	...
	<div class="maincontent">
		...
		<?php
			...
			*/
			...
			$reptime = '';
			$disp = $pc_phone = $pc_text = $pc_email = $latest_scheduled = '';
		...
		<div id="contact_edit_infobox" class="opacity95">
			...
			<p>
				<b>Inviter:</b><br /><?php echo $invitername; ?>
			</p>
			<p>
		...
		<div class="editcontactbox roundcorners opacity95">
			<div class="editcontactform">
					...
					<form name="edit_contact_record" id="edit_contact_record" onSubmit="return updateContact();" class="pure-form pure-form-stacked" >
						...
						<fieldset>
							<legend>Chronological History: Communication & Notes</legend>
							
							<div class="pure-g">
							
								<div class="pure-u-1 pure-u-1-2">
									<!-- Comm History -->
									<label for="matrix_history">Communications (text,phone,email):</label>
								...
								<div class="pure-u-1 pure-u-1-2">
									<!-- Notes -->
									<label for="notes">Notes:</label>
									<textarea id="notes_history" name="notes_history" rows="12" cols="50" readonly><?php echo stripslashes($note_str); ?></textarea> 
								</div>

$(document).ready(function() {
	...
	$('img#add_note').click(function (e) {
		...
		if (notes != ''){
			...
			//RELOAD NOTES
			$.ajax({
				url:"ajax_reload_notes.php",
				type: "GET",
				data: {cid: cid},
				dataType: "html",		
				success:function(result){
					$("#notes_history").val(result);
				}	//end success:function
			}); //end $.ajax
			//RELOADS PAGE
...
function consultantEventModal(month, day, year) {
	//alert(month+' '+day+' '+year);
	$.get("ajax_consultant_events_modal.php", 
		{ month: month, 
		  day: day, 
...
function displayConsultantEventInfo(repid, ev_id){

	//Get the data and display it in the .addevent modal
	//AJAX - Reload the consultantevents div
	$.ajax({
		url:"ajax_display_consultantevent_for_edit.php",
		type: "GET",
...
function displayConsultantEventDeleteInfo(repid, ev_id){

	//Get the data and display it in the .addevent modal
	//AJAX - Reload the consultantevents div
	$.ajax({
		url:"ajax_display_consultantevent_for_delete.php",
		type: "GET",
		data: {repid: repid, event_id: ev_id },
		dataType: "html",		
		success:function(result){
...
function updateConsultantEvent() {
	var msgs = '';
	//Event Title
	...
	//Event Desc
	var eventDesc = $('.addevent #edit_event_shortdesc').val();
	if (eventDesc == ''){
		msgs += "Event description is blank.<br />";
	}
	//Event Start HH
	...
	var calId = $('#editevent_cal_id').val();
	...
	if (msgs == ''){
		//AJAX POST
		$.ajax({
			url:"ajax_consultant_calendar_editevent.php",
			type: "POST",
			data: { calid: calId,
					event_title: eventTitle, 
					event_desc: eventDesc,
		...
		//AJAX - Reload the consultantevents div
		$.ajax({
			url:"ajax_reload_consultantevents.php",
			type: "GET",
			data: {month: cMonth, day: cDay, year: cYear},
			dataType: "html",		
			success:function(result){
...
function deleteConsultantEvent(){

	//calendar entry id field
	var calId = $('#deleteevent_cal_id').val();
	...
	$.ajax({
		url:"ajax_consultant_calendar_deleteevent.php",
		type: "POST",
		data: { calid: calId,
				month: cMonth,
				day: cDay,
...
function displayConsultantAddEvent(){
	...
	//AJAX POST - Delete script
	$.ajax({
		url:"ajax_displayform_add_consultantevent.php",
		type: "GET",
		data: {month: cMonth, day: cDay, year: cYear},
		dataType: "html",		
		success:function(result){
...
function addNewConsultantEvent(){
	
	var msgs = '';
	//Event Title
	var eventTitle = $('.addevent #new_event_title').val();
	if (eventTitle == ''){
		msgs = "Event title is blank.<br />";
	}
	//Event Desc
	var eventDesc = $('.addevent #new_event_shortdesc').val();
	if (eventDesc == ''){
		msgs += "Event description is blank.<br />";
	}
	//Event Start HH
	var eventStarthh = $('.addevent #new_event_start_hh :selected').val();
	if (eventStarthh == ''){
		msgs += "Select hours for start time.<br />";
	}	
	//Event Start MM
	var eventStartmm = $('.addevent #new_event_start_mm :selected').val();
	if (eventStartmm == ''){
		msgs += "Select minutes for start time.<br />";
	}
	//Event End HH
	var eventEndhh = $('.addevent #new_event_end_hh :selected').val();
	if (eventEndhh == ''){
		msgs += "Select hours for end time.<br />";
	}
	//Event End MM
	var eventEndmm = $('.addevent #new_event_end_mm :selected').val();
	if (eventEndmm == ''){
		msgs += "Select minutes for end time.<br />";
	}

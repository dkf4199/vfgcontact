	...
	<div class="maincontent">
		...
		<?php
			...
			*/
			...
			$start_date = $seven_day_date = $tier3_date = $crm_date = $tier4_date = $plan = $pers_ref = '';
			$plan_points = $plan_date = $plan_percent25 = $promo_to = $thirty_day_date = $recruit1 = $recruit2 = '';
			$recruit1_points = $recruit2_points = $recruits_date = $recruits_percent25 = $recruits_promo_to = '';
			...
			$q = "SELECT firstname, lastname, email, phone,
						...
						last_scheduled_tiercall, contact_source, start_date, seven_day_date,
						tier3_date, crm_date, tier4_date, plan, pers_ref, plan_points, plan_date,
						plan_percent25, promo_to, thirty_day_date, recruit1, recruit1_points,
						recruit2, recruit2_points, recruits_date, recruits_percent25, recruits_promo_to,
						spouse_name, anniversary_date 
				  FROM contacts
			...
			if ($rs){
				if (mysqli_num_rows($rs) == 1) {
					while ($row = mysqli_fetch_array($rs, MYSQLI_ASSOC)) {
						...
						$seven_day_date = $row['seven_day_date'];
						$tier3_date = $row['tier3_date'];
						$crm_date = $row['crm_date'];
						$tier4_date = $row['tier4_date'];
						$plan = $row['plan'];
						...
						$thirty_day_date = $row['thirty_day_date'];
						$recruit1 = $row['recruit1'];
						$recruit1_points = $row['recruit1_points'];
						$recruit2 = $row['recruit2'];
						$recruit2_points = $row['recruit2_points'];
						$recruits_date = $row['recruits_date'];
		...
		<div class="editcontactbox roundcorners opacity95">
			<div class="editcontactform">
				...
				<form name="edit_contact_record" id="edit_contact_record" onSubmit="return updateContact();" class="pure-form pure-form-stacked" >
					...
					<fieldset>
						...
						<div class="pure-g">
							...
							<div class="pure-u-1 pure-u-1-3">
								...
								<input type="text" name="seven_day_date" id="seven_day_date" value="<?php echo $seven_day_date; ?>" />
							</div>
							...
							<div class="pure-u-1 pure-u-1-2">
								...
								<input type="text" name="dp_tier3_date" id="dp_tier3_date" value="<?php echo $tier3_date; ?>" />
							</div>
							<!-- CRM Date -->
							<div class="pure-u-1 pure-u-1-2">
								<label for="dp_crm_date">CRM Date:</label>
								<input type="text" name="dp_crm_date" id="dp_crm_date" value="<?php echo $crm_date; ?>" />
							</div>
							
							<!-- Tier 4 Date -->
							<div class="pure-u-1">
								<label for="dp_tier4_date">Tier 4 Date:</label>
								<input type="text" name="dp_tier4_date" id="dp_tier4_date" value="<?php echo $tier4_date; ?>" />
							</div>
							
							<!-- Plan - PERS/REF - Plan Points -->
							<div class="pure-u-1 pure-u-1-3">
								<label for="plan">Plan:</label>
								<input type="text" name="plan" id="plan" value="<?php echo $plan; ?>"  maxlength="50" />
							</div>
							<div class="pure-u-1 pure-u-1-3">
							...
							<div class="pure-u-1 pure-u-1-3">
								...
								<input type="text" name="dp_plandate" id="dp_plandate" value="<?php echo $plan_date; ?>" />
							</div>
							<div class="pure-u-1 pure-u-1-3">
							...
							<div class="pure-u-1 pure-u-1-3">
								...
								<input type="text" name="thirty_day_date" id="thirty_day_date" value="<?php echo $thirty_day_date; ?>" />
							</div>					
							<div class="pure-u-1 pure-u-1-3"></div>
							...
							<div class="pure-u-1 pure-u-1-2">
								...
								<input type="text" name="recruit1_points" id="recruit1_points" value="<?php echo $recruit1_points; ?>"  maxlength="5" />
							</div>
							...
							<div class="pure-u-1 pure-u-1-2">
								...
								<input type="text" name="recruit2_points" id="recruit2_points" value="<?php echo $recruit2_points; ?>"  maxlength="5" />
							</div>
							
							<!-- Recruit Date - Recruit 25% - Recruit Promo To -->
							<div class="pure-u-1 pure-u-1-3">
								<label for="dp_recruitsdate">Date:</label>
								<input type="text" name="dp_recruitsdate" id="dp_recruitsdate" value="<?php echo $recruits_date; ?>" />
							</div>
							<div class="pure-u-1 pure-u-1-3">
					...
					<input type="hidden" id="og_start_date" name="og_start_date" value="<?php echo $start_date; ?>" />
					<input type="hidden" id="og_seven_day_date" name="og_seven_day_date" value="<?php echo $seven_day_date; ?>" />
					<input type="hidden" id="og_tier3_date" name="og_tier3_date" value="<?php echo $tier3_date; ?>" />
					<input type="hidden" id="og_crm_date" name="og_crm_date" value="<?php echo $crm_date; ?>" />
					<input type="hidden" id="og_tier4_date" name="og_tier4_date" value="<?php echo $tier4_date; ?>" />
					<input type="hidden" id="og_plan" name="og_plan" value="<?php echo $plan; ?>" />
					...
					<input type="hidden" id="og_recruit1_points" name="og_recruit1_points" value="<?php echo $recruit1_points; ?>" />
					<input type="hidden" id="og_recruit2" name="og_recruit2" value="<?php echo $recruit2; ?>" />
					<input type="hidden" id="og_recruit2_points" name="og_recruit2_points" value="<?php echo $recruit2_points; ?>" />

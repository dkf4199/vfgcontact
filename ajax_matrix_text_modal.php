...
session_start();
	...
	$displayform = '<div style="display:none">
		...
		<h1 class="contact-title">3x3 Text Note for '.$fname.' '.$lname.' at '.$toemail.'.</h1>
		<div class="contact-loading" style="display:none"></div>
		<div class="contact-message" style="display:none"></div>
		<br />
		<ul>
			<li>
				<label for="text_note">Text Note:</label>
				<input type="text" name="text_note" id="text_note" class="input250" maxlength="30" value="" />
			</li>
			<li>
				<label>&nbsp;</label>
				<a href="'.$currcid.'" class="matrixtextlink">Save Text Note</a>&nbsp;&nbsp;

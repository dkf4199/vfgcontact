...
<div id="wrapper">
	...
	<div class="maincontent">
		...
		<?php
			...
			$fn = $ln = $ph = $tzone = $sudt = $vid = $rvid = $gmail = $gpass = $rl_man = $rl_con = '';
			...
			$q = "SELECT firstname, lastname, phone,
						...
						replevel_manager, replevel_consultant,
			...
			<div class="editcontactform">
					...
					<table align="center" border="0" width="75%">
						...
						<tr>	<!-- Event Levels for Emails -->
							...
							?>
							<td>
								<!-- 01-18-2014 took out the position checkboxes. Find them in admin edit rep BKUP -->
								&nbsp;
							</td>
							<td>
						...
						<tr>
							<td><!-- Rep Manager -->
								<label for="rep_manager">Manager:</label>
								<?php
								$selected_rlm = "";
								$selected_rlm = $rl_man;
								
								echo '<select name="rep_manager" id="rep_manager">';
						...
						<tr>
							<td colspan="2" align="center" >
								...
								<input type="hidden" id="og_rl_man" name="og_rl_man" value="<?php echo $rl_man; ?>" />

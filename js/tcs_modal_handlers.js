$(document).ready(function() {
	...
	$("#dp_plan_date").datepicker({ dateFormat: "mm-dd-yy" });
	$("#dp_recruits_date").datepicker({ dateFormat: "mm-dd-yy" });
	$("#dp_anniversary_date").datepicker({ dateFormat: "mm-dd-yy" });
	...
	$( "#dp_startdate" ).change(function() {
		...
		if (pickedDate != ''){
			...
			$("#og_seven_day_date").val(datestring7);
			...
			$("#og_thirty_day_date").val(datestring30);
			$("#hidden_thirty_day").val(datestring30);
			//var htd = $("#og_thirty_day_date").val();
			//alert(htd);
		}
	...
	//***********************************************************
	// THE CELLPHONE ICON NEXT TO THE phone 1 input field
	...
	//***********************************************************
	// THE CELLPHONE ICON NEXT TO THE secondary phone 2 input field
	// DISPLAY PHONE SCRIPTS MODAL
	//***********************************************************
	$('.editcontactform a.secondary_phone_modal_main').click(function (e) {
		e.preventDefault();
		...
		var curr_lname = $('.editcontactform #last_name').val();
		var curr_email = $('.editcontactform #email').val();
		var contactPhone = $('.editcontactform #secondary_phone').val();
		var cTzone = $('.editcontactform #timezone :selected').val();
		var curr_id = $('.editcontactform #cid').val();
		//alert(curr_fname+' '+curr_lname+' '+curr_email);
		...
		if (contactPhone != ''){
			...
			$("#update_messages").html("<p>Update contact's record with their secondary phone number to use the phone modal.</p>");
		}
		
	});		//close $('.editcontactform a.secondary_phone_modal_main').click(function (e)
	...
	// DISPLAY TEXT MODAL
	//***********************************************************
	$('.editcontactform a.secondary_text_modal_main').click(function (e) {
		e.preventDefault();
		...
		var curr_fname = $('.editcontactform #first_name').val();	//contacts firstname
		var curr_lname = $('.editcontactform #last_name').val();	//contacts lastname
		curr_phone = $('.editcontactform #secondary_phone').val();	//contacts secondary phone
		var curr_email = $('.editcontactform #email').val();		//contacts email (don't really need)
		var curr_id = $('.editcontactform #cid').val();
		//alert(curr_fname+' '+curr_lname+' '+curr_email);
	...
	});		//close $('.editcontactform a.secondary_text_modal_main').click(function (e)
	...
	$('img#add_note').click(function (e) {
		...
		var notes = $("#notes").val();		//notes field
		var cid = $("#cid").val();			//contact id
		
		var contactFirst = $("#original_firstname").val();
		var contactLast = $("#original_lastname").val();
		var invName = $("#iname").val();
		var invPhone = $("#iphone").val();
		var invEmail = $("#iemail").val();
		var manName = $("#mname").val();
		var manPhone = $("#mphone").val();
		var manEmail = $("#memail").val();
		var conName = $("#cname").val();
		var conPhone = $("#cphone").val();
		var conEmail = $("#cemail").val();
		var addlName = $("#aname").val();
		var addlPhone = $("#aphone").val();
		var addlEmail = $("#aemail").val();
...
function updateContact(){
	...
	var phone2 = $("#secondary_phone").val();
	var ogPhone2 = $("#og_secondary_phone").val();
	var city = $("#city").val();
	...
	var ogSpouseName = $("#og_spouse_name").val();
	var anniversaryDate = $("#dp_anniversary_date").val();
	var ogAnniversaryDate = $("#og_anniversary_date").val();
	...
	var ogStartDate = $("#og_startdate").val();
	...
	var planDate = $("#dp_plan_date").val();
	var ogPlanDate = $("#og_plan_date").val();
	var recruitsDate = $("#dp_recruits_date").val();
	var ogRecruitsDate = $("#og_recruits_date").val();
	var planName = $("#plan_name").val();
	var ogPlanName = $("#og_plan_name").val();
	...
	if (phone2 != ogPhone2) {dataChanged = true;}
	if (city != ogCity) {dataChanged = true;}
	if (state != ogState) {dataChanged = true;}
	if (timeZone != ogTimeZone) {dataChanged = true;}
	if (spouseName != ogSpouseName) {dataChanged = true;}
	if (anniversaryDate != ogAnniversaryDate) {dataChanged = true;}
	...
	if (recruitsDate != ogRecruitsDate) {dataChanged = true;}
	
	if (planName != ogPlanName) {dataChanged = true;}
	...
	$("#og_secondary_phone").val(phone2);
	$("#original_city").val(city);
	$("#original_state").val(state);
	$("#original_timezone").val(timeZone);
	$("#og_spouse_name").val(spouseName);
	$("#og_anniversary_date").val(anniversaryDate);

...
$_SESSION['from_page'] = 'rep_search_first.php';
$_SESSION['back_btn_text'] = 'Back To Search by First Name';
?>
<!DOCTYPE html>
<html>
<head>
...
<div id="wrapper">
	...
	<div class="maincontent">
		...
		<div style="text-align:center;">
			<form method="get" action="rep_search_first.php">
		...
		<?php
			...
			//Link back fields for edit screen
			$_SESSION['from_page'] = 'rep_search_first.php';
			$_SESSION['back_btn_text'] = 'Back To First Name Search';

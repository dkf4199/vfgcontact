	...
	<div class="maincontent">
		...
		<?php
			...
			*/
			...
			$spouse_name = $anniversary_date = $ph2 = '';
			...
			$q = "SELECT firstname, lastname, email, phone,
						...
						recruits_promo_to, spouse_name, anniversary_date, secondary_phone 
				  FROM contacts
			...
			// ADDITIONAL REP
			$addl_rep_name = $addl_rep_phone = $addl_rep_email = '';
				...
				if ($rs){
					if (mysqli_num_rows($rs) == 1) {
						while ($row = mysqli_fetch_array($rs, MYSQLI_ASSOC)) {
							...
							$addl_rep_phone = $row['phone'];
							$addl_rep_email = $row['gmail_acct'];
						}
					}
					mysqli_free_result($rs);
				}
		...
		<div class="editcontactbox roundcorners opacity95">
			<div class="editcontactform">
				...
				<form name="edit_contact_record" id="edit_contact_record" onSubmit="return updateContact();" class="pure-form pure-form-stacked" >
					...
					<fieldset>
						...
						<div class="pure-g">
							...
							<div class="pure-u-1 pure-u-1-4">
								<!-- phone -->
								<label>Phone 2:</label>
								<input type="text" name="secondary_phone" id="secondary_phone" class="input100"
											value="<?php echo $ph2; ?>" />&nbsp;
								<a href="<?php echo $currcid; ?>" class="secondary_phone_modal_main">
									<img src="./images/smallicons/cellphone1.png" />
								</a>
								<a href="<?php echo $currcid; ?>" class="secondary_text_modal_main">
									<img src="./images/smallicons/text.png" />
								</a>
							</div>
							<div class="pure-u-1 pure-u-1-4">
					...
					<input type="hidden" id="og_secondary_phone" name="og_secondary_phone" value="<?php echo $ph2; ?>" />
					...
					<input type="hidden" id="hidden_seven_day" name="hidden_seven_day" value="" />
					<input type="hidden" id="hidden_thirty_day" name="hidden_thirty_day" value="" />
					<!-- hiddens for inviter, manager, consultant, additional rep -->
					<input type="hidden" id="iname" name="iname" value="<?php echo $invitername; ?>" />
					<input type="hidden" id="iphone" name="iphone" value="<?php echo $inviterphone; ?>" />
					<input type="hidden" id="iemail" name="iemail" value="<?php echo $inviteremail; ?>" />
					<input type="hidden" id="mname" name="mname" value="<?php echo $man_name; ?>" />
					<input type="hidden" id="mphone" name="mphone" value="<?php echo $man_phone; ?>" />
					<input type="hidden" id="memail" name="memail" value="<?php echo $man_email; ?>" />
					<input type="hidden" id="cname" name="cname" value="<?php echo $con_name; ?>" />
					<input type="hidden" id="cphone" name="cphone" value="<?php echo $con_phone; ?>" />
					<input type="hidden" id="cemail" name="cemail" value="<?php echo $con_email; ?>" />
					<input type="hidden" id="aname" name="aname" value="<?php echo $addl_rep_name; ?>" />
					<input type="hidden" id="aphone" name="aphone" value="<?php echo $addl_rep_phone; ?>" />
					<input type="hidden" id="aemail" name="aemail" value="<?php echo $addl_rep_email; ?>" />
